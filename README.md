...
![Data Science](https://img.shields.io/badge/Data_Science-Essentials-4a4f68?style=for-the-badge&logo=databricks&logoColor=white)

<p align="center">
  <img src="https://img.shields.io/badge/TERMS-64%2B-c8ff00?style=for-the-badge&labelColor=08090d" />
  <img src="https://img.shields.io/badge/ALPHABET-26_Letters-8b90a8?style=for-the-badge&labelColor=08090d" />
  <img src="https://img.shields.io/badge/SEARCH-Real_Time-4a4f68?style=for-the-badge&labelColor=08090d" />
  <img src="https://img.shields.io/badge/AUTHOR-Willie_Conway-c8ff00?style=for-the-badge&labelColor=08090d" />
</p>
...
| Term                  | Definition                                                                                                                                                        |
| --------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Alpha value** | A threshold of statistical significance used in hypothesis testing — commonly set to 0.05, meaning a 5% risk of concluding a difference exists when it does not. |
...
| **Business analyst** | A data professional who bridges business objectives and technical solutions — gathering requirements, conducting feasibility studies, and recommending process improvements.                   |
...
| **Dependent variable**     | The outcome variable in a study — the one that may change in response to manipulation of the independent variable. Often denoted Y in regression models.                           |
...
| **Linearity**           | A relationship where the change in the dependent variable is proportional to the change in the independent variable — the core assumption of linear regression.     |
...
| Term                                | Definition                                                                                                                                               |
| ----------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Nominal variable**          | A categorical variable whose categories have no inherent order — for example, country, colour, or blood type.                                           |
| **Normal distribution**       | A symmetric, bell-shaped probability distribution defined by mean μ and standard deviation σ. About 68% of values fall within ±1σ of the mean.       |
...
| **Null hypothesis**           | The default assumption in a hypothesis test — usually no effect, no difference, or no relationship. Denoted H₀. It is either rejected or not rejected. |
...
| **P-value**               | The probability of obtaining results at least as extreme as those observed, assuming H₀ is true. A small p-value (e.g. < 0.05) is evidence against H₀.   |

### **Q**

| Term                                | Definition                                                                                                                                    |
| ----------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- |
| **Qualitative forecasting**   | Prediction methods relying on expert judgment and structured opinion — such as the Delphi method — rather than historical numerical data.   |
| **Quantitative forecasting**  | Prediction methods using historical numerical data and statistical models — such as time series or regression — to project future values.   |
...
| **Regression model**    | The mathematical equation — usually Y = β₀ + β₁X + ε — representing the estimated relationship between dependent and independent variables.                |
...
| **Simple linear regression** | A regression model with exactly one independent variable, producing the best-fit line Y = β₀ + β₁X + ε through the data.                                 |
...
| **Standard deviation**       | The square root of variance — a measure of the average distance of observations from the mean, expressed in the same units as the data.                      |
...
| **Statistical parameter**    | A numerical characteristic of a population — such as the mean (μ) or standard deviation (σ) — as opposed to a sample statistic estimated from data.       |
| **Statistical tools**        | Software and libraries — such as Excel, R, Python (pandas, scipy), SAS, and SPSS — used to apply statistical methods.                                       |
...
| Term              | Definition                                                                                                                                            |
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Z score** | A standardised measure expressing how many standard deviations an observation is from the mean: z = (x − μ) / σ. Enables comparison across scales. |

---

## 🎨 **Design & Aesthetics**

### **Modern Data Science Reference** 📖

- **Dark background** (`#08090d`) — easy on the eyes for extended reading
- **Lime accent** (`#c8ff00`) for search highlights and interactive elements
- **Subtle grid background** for depth
- **Large hero section** with Greek sigma (Σ) watermark
- **Sticky top banner** with search and reset controls
- **Vertical A-Z navigation** fixed on the left

### **Typography** ✍️

- **DM Serif Display** — Elegant serif headers, term names, hero title
- **Outfit** — Clean sans-serif for body text and definitions
- **JetBrains Mono** — Monospace for statistics and technical elements
...
| 0:05 | Letter Nav | Click "R" → Show all R terms (Regression, R-squared)            |
| 0:10 | Search     | Type "regression" → Cards filter to 8 matching terms            |
| 0:15 | Highlight  | Search terms highlighted in lime yellow                          |
| 0:20 | Card Hover | Hover over "Linear Regression" → Lime left border appears       |
| 0:25 | Letter Nav | Click "ALL" → All 64 terms reappear                             |
| 0:30 | Search     | Type "distribution" → Shows Normal Distribution, T Distribution |
| 0:35 | Counter    | Term count updates from 64 → 4                                  |
| 0:40 | Reset      | Click "Reset" button → All terms restored                       |
...
- **American Statistical Association** — Statistical terminology
- **OpenIntro Statistics** — Open-source statistics textbook
- **Willie Conway** — Author and data science educator

---

## 📧 **Contact**

- **GitHub Issues**: [Create an issue](https://github.com/Willie-Conway/Statistics-Glossary/issues)
- **Website**: https://willie-conway.github.io/Statistics-Glossary/
...
<p align="center">
  <strong>📊 Statistics Fundamentals Glossary — Your Essential Statistics Reference 📊</strong>
</p>

<p align="center">
  <img src="https://img.shields.io/badge/BUILT_WITH-❤️-c8ff00?style=for-the-badge&labelColor=08090d" />
  <img src="https://img.shields.io/badge/FOR-Data_Professionals-8b90a8?style=for-the-badge&labelColor=08090d" />
  <img src="https://img.shields.io/badge/TRY_IT_LIVE-4a4f68?style=for-the-badge&labelColor=08090d" />
</p>
